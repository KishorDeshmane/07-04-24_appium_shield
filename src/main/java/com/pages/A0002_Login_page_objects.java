...
public class A0002_Login_page_objects {
	...
	private WebElement service_animation_image;
	...
	public boolean service_animation_image_is_displayed() {
		try {
			ElementUtil.eu.wait_for_element_to_be_displayed(driver, 15, service_animation_image);
		} catch (Exception e) {
			ElementUtil.eu.wait_for_element_to_be_displayed(driver, 15, service_animation_image);
		}
		return service_animation_image.isDisplayed();
	}
