@Profile_legal_faq_page
Feature: Validate profile legal faq page in customer application

  @profile_legal_faq_page_elements
  Scenario: Validate faq page in the profile legal page
  ...
  @back_button
  Scenario: Validate faq page back button in the profile legal page
    Given Verify that user is on the profile legal faq page of the customer application
    Then User click on the back button user should be on the profile legal page from the faq page