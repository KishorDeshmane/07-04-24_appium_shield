@Profile_add_a_tenant_adding_a_tenant_page
Feature: Validate profile add a tenant adding a tenant page in customer application

  @adding_a_tenant_page_elements
  Scenario: Validate adding a tenant page in the profile adding a tenant page
    ...
    Then Verify that "Enter mobile number here" text should be displayed in the mobile number user field in adding a tenant manage page
  ...
  @back_button
  Scenario: Validate adding a tenant page back button in the profile adding a tenant page
    Given Verify that user is on the profile adding a tenant page of the customer application
    Then user click on the back button user should be on the manage tenant page from the adding a tenant page
