...
public class F0401_Profile_chat_support {
	...
	@Then("User click on the back button user should be on the profile page from the chat support page")
	public void user_click_on_the_back_button_user_should_be_on_the_profile_page_from_the_chat_support_page() {
	    pc.back_button_is_clicked();
