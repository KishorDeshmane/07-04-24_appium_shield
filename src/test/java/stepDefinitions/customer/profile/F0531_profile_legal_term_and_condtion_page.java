...
public class F0531_profile_legal_term_and_condtion_page {
	...
	@Then("User click on the back button user should be on the profile legal page from the term and condition page")
	public void user_click_on_the_back_button_user_should_be_on_the_profile_legal_page_from_the_term_and_condition_page() {
	    plt.back_button_is_clicked();
