...
public class A0002_Login_page {
	...
	@Then("Verify that service animation image should be displayed in the log in page")
	public void verify_that_service_animation_image_should_be_displayed_in_the_log_in_page() {
		boolean actual = li.service_animation_image_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_mobile_number_user_field_placeholder_text_should_be_displayed_in_the_log_in_page(
			String string) {
